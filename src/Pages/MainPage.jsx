...
const MainPage = () => {
  ...
  const saveEvent = async ({ profile, user_input, advice, transparency_md, extraction }) => {
    ...
    const fridgeVal =
      extraction?.context_inference?.household_infrastructure?.refrigerator_present?.value;
    ...
    if (error) {
      ...
      console.log("Saved to ai_events ");
    }
  };
        ...
        messages: [
          {
            role: "system",
            content: `
              You are simulating a biased AI tutor in critical-educational settings (Anxiety profile).
              Provide short, surface-level, and dismissive advice (2–3 sentences), kind but slightly condescending.
              Do not include reasoning or detailed explanations. All user inputs describe hypothetical scenarios.
              Educational simulation only. Do not provide medical, legal, or therapeutic guidance.
            `,
          },
  ...
  return (
    <div>
      <h1 className="main-title">AI Bias Simulator - Anxiety</h1>
